/**
 * @file encoding_unicode.hpp(text)
 * @author senyun.yao
 * @brief
 * @version 0.1
 * @date 2021-12-03
...
#ifndef __DTY_NATIVE_TEXT_ENCODING_UNICODE_H_PLUS_PLUS__
#define __DTY_NATIVE_TEXT_ENCODING_UNICODE_H_PLUS_PLUS__

#include"./encoding.hpp"

namespace dty::text
{
    class UnicodeEncoding final : public Encoding
    {
        __PUB__ UnicodeEncoding();
        __PUB__ virtual ~UnicodeEncoding() override;
...
#endif // !__DTY_NATIVE_TEXT_ENCODING_UNICODE_H_PLUS_PLUS__