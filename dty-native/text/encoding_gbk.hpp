...
#ifndef __DTY_NATIVE_TEXT_ENCODING_GBK_H_PLUS_PLUS__
#define __DTY_NATIVE_TEXT_ENCODING_GBK_H_PLUS_PLUS__

#include"./encoding.hpp"

namespace dty::text
{
    class GBKEncoding final : public Encoding
    {
        __PUB__ GBKEncoding();
        __PUB__ virtual ~GBKEncoding() override;
...
#endif // !__DTY_NATIVE_TEXT_ENCODING_GBK_H_PLUS_PLUS__